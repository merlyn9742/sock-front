...
export class Sidebar {
  navItems: NavItem[] = [
    ...
    { label: 'Adquisiciones', iconClass: 'fas fa-shopping-cart', link: '/adquisiciones' },
    { label: 'Paquetes', iconClass: 'fas fa-cubes', link: '/paquetes' },
    { label: 'Precios', iconClass: 'fas fa-money-bill-wave', link: '/price-rules' },
    { label: 'Clientes', iconClass: 'fas fa-users', link: '/customer  ' },
    { label: 'Ventas', iconClass: 'fas fa-chart-line', link: '/ventas' },
